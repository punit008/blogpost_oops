                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Blogs</div>
                                            <a href="user_blog.php"><div class="h5 mb-0 font-weight-bold text-gray-800">Go to Blogs</div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Posts</div>
                                                <a href="user_post.php"><div class="h5 mb-0 font-weight-bold text-gray-800">Add Post</div></a>
                                        </div>
